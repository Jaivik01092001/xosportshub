          ...
          <div className="BuyerBids__list">
            ...
            {bids.map((bid) => (
              <div className="BuyerBids__item" key={bid.id}>
                ...
                <div className="BuyerBids__item-amount">${bid.bidAmount.toFixed(2)}</div>
                <div className="BuyerBids__item-date">{bid.date}</div>
                <div className={`BuyerBids__item-status ${getStatusClass(bid.status)}`}>
